    ...
    <footer className="text-white" style={{ backgroundColor: '#112329' }}>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          {/* Service Areas */}
          <div>
            <h4 className="text-lg font-bold text-white mb-4">Service Areas</h4>
            <ul className="space-y-2">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="tel:+17653771000" className="text-white hover:text-white/80 transition-colors">
                    765.377.1000
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href="mailto:info@pjsdoors.com" className="text-white hover:text-white/80 transition-colors text-sm">
                    info@pjsdoors.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-white/80">
                    ...
                    <span className="text-white font-medium">Call for Service!</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/60">
            ...
            <div className="flex gap-6">
              ...
              <a href="#warranty" className="hover:text-white/80 transition-colors">Warranty Info</a>
            </div>
          </div>
        </div>
      </div>
